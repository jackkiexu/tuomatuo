...
public class CrawlerChanYouJiAccountHelper {
    ...
    public static void main(String[] args) {
        CrawlerChanYouJiAccountHelper.getInstance().crawlerChanYouJi(1l, 2l);
    }

    public List<ChanYouJiAccountVO> crawlerChanYouJi(Long minId, Long maxId){
        ...
        List<ChanYouJiAccountVO> chanYouJiAccountVOList = new ArrayList<ChanYouJiAccountVO>();
        ...
        for(;nullCount <= 1000 && iInit <= iMax;iInit++){
            ...
            chanYouJiAccountVOList.add(chanYouJiAccountVO);
            try {
                Thread.sleep(150);
