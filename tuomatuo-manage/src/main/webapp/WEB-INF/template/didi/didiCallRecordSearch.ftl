...
function searchInit(url){
	...
	pager.pagination({
		...
		buttons:[{
		      ...
		      iconCls:'icon-edit',
		      text:'修改',
		      disabled:noPermis("callRecord","update"),
		      handler:function(){
		          editObj("${(cmodel.callRecord)!''}","${webRoot}/callRecord/view.do?id=","${webRoot}/callRecord/update.do","","400");
		      }
		},{
		      iconCls:'icon-remove',
		      text:'删除',
...
<div id="tb" style="padding:5px;height:auto">
	<form id="searchForm">
   	<div>
      开始时间: <input class="easyui-datebox" name="search.GED_startTime" id="search_startTime" style="width:80px">
      ...
      <br />
      结束时间: <input class="easyui-datebox" name="search.LTD_startTime" id="search_startTime" style="width:80px">
