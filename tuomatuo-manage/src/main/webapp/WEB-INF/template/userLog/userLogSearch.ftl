...
$(function(){
	...
	searchInit("${webRoot}/userLog/search.do");          
})
...
function searchInit(url){
	...
	pager.pagination({
		...
		buttons:[{
		      ...
		      handler:function(){
		 	     viewObj("${(cmodel.userLog)!''}","${webRoot}/userLog/view.do?id=");
		      }
		}]
	});
}
...
<div id="tb" style="padding:5px;height:auto">
	<form id="searchForm">
      ...
      结束时间: <input class="easyui-datebox" name="search.LTD_createTime" name="endTime" style="width:80px">
