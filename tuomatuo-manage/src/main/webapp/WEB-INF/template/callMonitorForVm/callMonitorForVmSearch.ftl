...
//初始化
$(function(){
	searchInit("${webRoot}/callMonitorForVm/search.do");
...
function searchInit(url){
	...
	pager.pagination({
		...
		buttons:[{
		      iconCls:'icon-lock',
		      text:'锁定帐号',
		      disabled:noPermis("callMonitorForVm","lock"),
		      handler:function(){
		 	     dealUserStatus("${(cmodel.callMonitorForVm)!''}锁定","${webRoot}/callMonitorForVm/lock.do?id=");
		      }
		},{
		      iconCls:'icon-unlock',
		      text:'解锁帐号',
		      disabled:noPermis("callMonitorForVm","unlock"),
		      handler:function(){
		          dealUserStatus("${(cmodel.callMonitorForVm)!''}解锁","${webRoot}/callMonitorForVm/unlock.do?id=");
		      }
		},{
		     iconCls:'icon-add',
		      text:'添加黑名单',
		      disabled:noPermis("callMonitorForVm","unlock"),
		      handler:function(){
		          addMobileToBlockList("${(cmodel.callMonitorForVm)!''}添加入黑名单","${webRoot}/callMonitorForVm/addMobileToBlockList.do?mobile=");
		      }
		}]
	});
}
