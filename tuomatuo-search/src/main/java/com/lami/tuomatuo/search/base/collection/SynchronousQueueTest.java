...
public class SynchronousQueueTest {
    ...
    private static final Logger logger = Logger.getLogger(SynchronousQueueTest.class);
    ...
    static class Product extends Thread {
        ...
        public void run() {
            while (true) {
                ...
                logger.info("Thread Id:" + getId() + "  生产了一个产品：" + rand);
                logger.info("Thread Id:" + getId() + " 等待两秒后运送出去...");
                try {
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    logger.info("Thread Id:" + getId() + " 消费了一个产品:" + queue.take());
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                logger.info("------------------------------------------");
