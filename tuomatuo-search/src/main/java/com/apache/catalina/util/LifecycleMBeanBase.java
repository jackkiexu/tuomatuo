...
public abstract class LifecycleMBeanBase extends LifecycleBase implements JmxEnabled{
     ...
     * with component that cannot (easily) navigate the component hierarchy to
    ...
    /**
     * Method implemented by sub-class to identify the domain in which MBeans
