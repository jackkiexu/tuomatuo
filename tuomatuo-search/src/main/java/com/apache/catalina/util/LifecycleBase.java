...
import com.apache.catalina.LifecycleState;
import com.apache.juli.logging.Log;
import com.apache.juli.logging.LogFactory;
import com.apache.tomcat.util.ExceptionUtils;
import com.apache.tomcat.util.res.StringManager;

/**
 * Base implementation of the {@link Lifecycle} interface that implementations the
...
public abstract class LifecycleBase  implements Lifecycle{
    ...
    /**
     * Allow sub class to fire {@link Lifecycle} events
     * @param type
     * @param data
     */
    ...
    /**
     * Sub-class must ensure that the state is changed to
    ...
    private synchronized void setStateInternal(LifecycleState state, Object data,
        ...
        log.info(sm.getString("lifecycleBase.setState", this, state));
        if(check){
            /**
