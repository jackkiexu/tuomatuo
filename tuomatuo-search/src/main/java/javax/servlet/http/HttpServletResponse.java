...
public interface HttpServletResponse extends ServletResponse {
    ...
    /**
     * Add a response header with the given name and value . This method allows
     * response headers to have multiple values
     * @param name
     * @param value
     */
    ...
    /**
     * Adds response header with the given name and integer value, This method
     ...
     * code SC_OK or SC_MOVE_TEMPORARILY). If there is an error, anf the
     * caller wished to invoke an error-page defined in the web application, the
    ...
    /**
     * Get ht HTTP status code for this Response
     * @return
     */
    int getStatus();
    ...
    /**
     * Return a Cloeection of all the header values associated with the
