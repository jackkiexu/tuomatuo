package com.lami.tuomatuo.web.sms.pipe.yupian;
/**http://www.yunpian.com/admin/module/sms_failure
 * http://www.jianshu.com/p/0516b8fb656b
...
public class YuPian {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        //修改为您要发送的手机号
        String mobile = "15221884515";

        /**************** 查账户信息调用示例 *****************/
        System.out.println("getUserInfo:"+YuPian.getUserInfo(apikey));

        /**************** 使用智能匹配模版接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "【托马托】您的验证码是1234";
        //发短信调用示例
         System.out.println("YuPian:"+YuPian.sendSms(apikey, text, mobile));
        ...
        String tpl_value = URLEncoder.encode("#code#",ENCODING) +"="
                ...
                + URLEncoder.encode("托马托",ENCODING);
        //模板发送的调用示例
        System.out.println("tpl_value:"+tpl_value);
//        System.out.println("tplSendSms:"+YuPian.tplSendSms(apikey, tpl_id, tpl_value, mobile));

        /**************** 使用接口发语音验证码 *****************/
//        String code = "1234";
//        System.out.println(YuPian.sendVoice(apikey, mobile ,code));
    }
