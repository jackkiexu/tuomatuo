...
CREATE TABLE `crawler_hupu_account` (
  ...
  PRIMARY KEY (`id`),
  KEY `keyname` (`name`),
  KEY `keyAvatarURL` (`avatarURL`(255))
) ENGINE=InnoDB AUTO_INCREMENT=3291414 DEFAULT CHARSET=utf8;
...
/*Table structure for table `dict_review_unit` */

DROP TABLE IF EXISTS `dict_review_unit`;

CREATE TABLE `dict_review_unit` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `userId` bigint(20) DEFAULT NULL COMMENT ''用户Id'',
  `uticket` varchar(128) DEFAULT NULL COMMENT ''用户每次进行复习的签名'',
  `wordAll` varchar(2048) DEFAULT NULL COMMENT ''单元的所有单词数'',
  `unit` bigint(20) DEFAULT NULL COMMENT ''单元'',
  `reviewSum` int(11) DEFAULT NULL COMMENT ''单元的单词书'',
  `hasReviewSum` int(11) DEFAULT NULL COMMENT ''已经复习的单词数'',
  `reviewOver` tinyint(3) DEFAULT ''0'' COMMENT ''是否已经复习完所有单词'',
  `isDelete` tinyint(4) DEFAULT ''0'',
  `createTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `endTime` timestamp NOT NULL DEFAULT ''0000-00-00 00:00:00'' COMMENT ''进行复习的截止时间'',
  `currentWord` varchar(64) DEFAULT NULL COMMENT ''当期正复习到的单词'',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `dict_user` (
  ...
  `passwd` varchar(16) DEFAULT NULL COMMENT ''密码'',
  `status` tinyint(3) DEFAULT NULL COMMENT ''状态'',
  `createTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT ''创建时间'',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `dict_word` */

DROP TABLE IF EXISTS `dict_word`;

CREATE TABLE `dict_word` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `word` varchar(64) NOT NULL COMMENT ''英文'',
  `unit` bigint(20) DEFAULT NULL COMMENT ''单元'',
  `explain` varchar(2048) DEFAULT NULL COMMENT ''中文解释'',
  `createTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT ''创建时间'',
  `updateTime` timestamp NOT NULL DEFAULT ''0000-00-00 00:00:00'',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
